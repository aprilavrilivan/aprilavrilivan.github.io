...
这是 Yifan Xu（Ivan）的纯静态个人学术主页。个人简介、研究兴趣、论文、教育经历、头像，以及 CS 180 与 CS 185/285 课程作品集已经填入；联系方式与 CV 目前仍使用占位内容。
...
1. 在 `index.html` 中搜索 `[`，逐项替换尚未完成的个人资料与联系方式。
2. 将后续项目图片和 CV 放入 `assets/`，再把对应路径添加到 `index.html`。
